...
import {
  ...
  useQueue,
  useReducedMotion
} from "./chunk-DII7UM7M.js";
import {
  require_react_dom
} from "./chunk-ZKLHUGFJ.js";
import {
  require_react
...
function useNotificationsState({ limit }) {
  ...
  const showNotification2 = (notification) => {
    ...
    update((notifications2) => {
      ...
      return [...notifications2, __spreadProps2(__spreadValues3({}, notification), { id })];
    });
    return id;
  };
  ...
  const hideNotification2 = (id) => update((notifications2) => notifications2.filter((notification) => {
